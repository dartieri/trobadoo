...
using trobadoo.com.web.Properties;
...
namespace trobadoo.com.web.Helpers
{
    ...
    public class ViewRendererHelper
    {
        ...
        /// </param>
        public ViewRendererHelper(ControllerContext controllerContext = null)
        {
        ...
        {
            var renderer = new ViewRendererHelper(controllerContext);
